...
public class View {
	...
	public final String INPUT_YOUR_NUMBER = "Try to gess number. Input your number from ";
	...
	public final String INPUTED = "You inputed: ";

	public void printMessage(String message) {
		System.out.println(message);
	}

	public void printMessage(String message, int playerNumber) {
